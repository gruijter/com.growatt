          ...
          if (validTypes.includes(dev.deviceType)) {
            ...
            try {
              ...
              if (devInfo && devInfo.pmax) {
                nominalPower = Number(devInfo.pmax || devInfo.nominalPower);
                maxChargePower = Number(devInfo.pmax || devInfo.nominalPower);
                maxDischargePower = Number(devInfo.pmax || devInfo.nominalPower);
              }
            } catch (e) {
