...
module.exports = class MyDriver extends Homey.Driver {
  ...
  async onInit() {
    ...
    if (this.getDevices().length) {
      this.log('Deprecated Growatt Inverter device(s) detected.');
      await this.homey.notifications.createNotification({
        excerpt: 'Deprecated Growatt Inverter device(s) detected. Please remove these devices and re-add them.',
      });
    }
